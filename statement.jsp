...
<div class="container-fluid gx-1 gx-lg-0 mt-3 mt-lg-5 px-4 px-lg-0 mx-5 mx-xl-5 float-end statementDiv border border-danger">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-6 border px-4 py-2">
            <a id="#">
                <div class="row border p-2 pb-3 rounded-2 statementCards">
                    <!-- Icon -->
                    ...
                    <div class="col-1 d-flex justify-content-end">
                        <div class="plusIconContainer fs-4">
                            <span><i class="bi bi-plus-circle-fill text-primary plusIcon"></i></span>
                        </div>
                    </div>
                </div>
            </a>
